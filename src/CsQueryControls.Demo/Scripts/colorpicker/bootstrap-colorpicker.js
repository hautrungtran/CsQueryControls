...
!function ($) {
    ...
    var Colorpicker = function (element, options) {
        ...
        this.input = this.isInput ? this.element : this.element.find('input:first');
    ...
    Colorpicker.prototype = {
        ...
        update: function () {
            ...
            this.previewColor();
            if (!this.required && !this.input.val()) {
                return;
            }
            try {
                this.input.val(this.format.call(this));
            } catch (e) {
        ...
        hide: function () {
            ...
            if (!this.isInput) {
                if (this.component) {
                    ...
                    if (this.input.val() !== '') {
                        this.input.prop('value', this.format.call(this)).trigger('change');
                    }
                }
        ...
        mousemove: function (e) {
            ...
            if (!this.isInput) {
                try {
                    this.input.val(this.format.call(this)).trigger('change');
                } catch (e) {
                    this.input.val(this.color.toHex()).trigger('change');
                }
            } else {
                try {
    ...
    $.fn.colorpicker = function (option, value) {
        return this.each(function () {
            ...
            if (!data) {
                if (option !== "destroy") {
                    $this.data('colorpicker', (data = new Colorpicker(this, $.extend({}, $.fn.colorpicker.defaults, $.getDataset(this), options))));
                }
            } else {
