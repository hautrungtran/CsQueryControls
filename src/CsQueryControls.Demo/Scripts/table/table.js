(function ($, undefined) {
    ...
    Table.prototype = {
        ...
        init: function (element, options) {
            ...
            if (!$.isPlainObject(options.selector) || $.isEmptyObject(options.selector)) {
                options.selector = $.fn.table.defaults.selector;
            }
            ...
            this.pagers = this.$element.find(this.selector.pager);
            this.firstButtons = this.$element.find(this.selector.firstButton);
            this.prevButtons = this.$element.find(this.selector.prevButton);
            ...
            this.pageIndexInputs = this.$element.find(this.selector.pageIndexInput);
            this.pageIndexButtons = this.$element.find(this.selector.pageIndexButton);

            this.commands = this.$element.find(this.selector.tableCommandContainer);
            this.format = options.format || $.fn.table.formats[options.language] || $.fn.table.formats['default'];
    ...
    $.fn.table.defaults = {
        ...
        selector: {
            ...
            pageSize: ".page-sizes",
            pageIndexContainer: ".page-index-container",
            pageIndexInput: ".page-index-input",
            pageIndexButton: ".page-index-button"
        },
        ...
        getPageDisplayText: function (pageIndex, pageSize, total) {
            var start = formatNumber((pageIndex * pageSize + 1), this.format.step, this.format.comma, this.format.decimal);
            ...
            var totalPage = formatNumber(this._getTotalPages(total, pageSize), this.format.step, this.format.comma, this.format.decimal);
