...
(function ($) {
    ...
    DateTimePicker.prototype = {
        ...
        init: function (element, options) {
            ...
            this._compileFormat();
            if (this.component) {
                icon = this.component.find('.glyphicon');
            }
            if (this.pickTime) {
                if (icon && icon.length) this.timeIcon = icon.data('timeIcon');
            ...
            this.required = options.required || $.fn.datetimepicker.defaults.required;
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                $this.data('datetimepicker', (data = new DateTimePicker(
                  this, $.extend({}, $.fn.datetimepicker.defaults, dataset, options))));
            }
